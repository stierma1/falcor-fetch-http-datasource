...
function FetchHttpSource(jsongUrl, config) {
...
FetchHttpSource.prototype = {
  // because javascript
  constructor: FetchHttpSource,
  /**
...
// ES6 modules
FetchHttpSource.FetchHttpSource = FetchHttpSource;
FetchHttpSource['default'] = FetchHttpSource;
// commonjs
module.exports = FetchHttpSource;
